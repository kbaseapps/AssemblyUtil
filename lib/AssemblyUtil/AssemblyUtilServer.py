...
def get_config():
    ...
    for nameval in config.items(get_service_name() or 'AssemblyUtil'):
        retconfig[nameval[0]] = nameval[1]
    return retconfig

config = get_config()

from AssemblyUtil.AssemblyUtilImpl import AssemblyUtil  # noqa @IgnorePep8
impl_AssemblyUtil = AssemblyUtil(config)
...
class Application(object):
    ...
    def __init__(self):
        ...
        self.rpc_service.add(impl_AssemblyUtil.get_fastas,
                             name='AssemblyUtil.get_fastas',
                             types=[dict])
        self.method_authentication['AssemblyUtil.get_fastas'] = 'required'  # noqa
        ...
        self.rpc_service.add(impl_AssemblyUtil.save_assembly_from_fasta2,
                             name='AssemblyUtil.save_assembly_from_fasta2',
                             types=[dict])
        self.method_authentication['AssemblyUtil.save_assembly_from_fasta2'] = 'required'  # noqa
