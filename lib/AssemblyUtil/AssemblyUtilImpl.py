...
class AssemblyUtil:
    ...
    def save_assembly_from_fasta(self, ctx, params):
        ...
        try:
            ...
            if 'Valid Content-Length header >= 0 required for upload form part' in str(err):
                print('No output generated by the app.  The combination of data and input parameters resulted in no valid output.')
            else:
