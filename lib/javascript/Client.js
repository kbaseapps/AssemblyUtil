...
function AssemblyUtil(url, auth, auth_cb, timeout, async_job_check_time_ms, service_version) {
    var self = this;
    ...
    var _auth_cb = auth_cb;
     ...
     this.get_assembly_as_fasta = function (params, _callback, _errorCallback) {
        ...
        return json_call_ajax(_url, "AssemblyUtil.get_assembly_as_fasta",
            [params], 1, _callback, _errorCallback);
    };
 
     this.export_assembly_as_fasta = function (params, _callback, _errorCallback) {
        if (typeof params === 'function')
            throw 'Argument params can not be a function';
        if (_callback && typeof _callback !== 'function')
            throw 'Argument _callback must be a function if defined';
        ...
        if (typeof arguments === 'function' && arguments.length > 1+2)
            throw 'Too many arguments ('+arguments.length+' instead of '+(1+2)+')';
        return json_call_ajax(_url, "AssemblyUtil.export_assembly_as_fasta",
            [params], 1, _callback, _errorCallback);
    };
 
     this.save_assembly_from_fasta = function (params, _callback, _errorCallback) {
        if (typeof params === 'function')
            throw 'Argument params can not be a function';
        if (_callback && typeof _callback !== 'function')
            throw 'Argument _callback must be a function if defined';
        ...
        if (typeof arguments === 'function' && arguments.length > 1+2)
            throw 'Too many arguments ('+arguments.length+' instead of '+(1+2)+')';
        return json_call_ajax(_url, "AssemblyUtil.save_assembly_from_fasta",
            [params], 1, _callback, _errorCallback);
    };
    ...
    this.status = function (_callback, _errorCallback) {
        ...
        return json_call_ajax(_url, "AssemblyUtil.status",
